...
const chainIds = [
  ...
  31, 534352, 534351, 11011, 50312, 1868, 1946, 16, 146, 57054, 1660990954,
...
export const networkMetadata = {
  ...
  'cyber-testnet': {
    ...
    explorer: {
      ...
      apiUrl: 'https://cyber-testnet.socialscan.io/api',
    },
    currency: Currency.ETH,
  },
  'expchain-testnet': {
  ...
  'fraxtal-testnet': {
    ...
    explorer: {
      ...
      apiUrl: 'https://holesky.fraxscan.com/api',
    },
    currency: Currency.frxETH,
  },
  'gameswift-chain-testnet': {
  ...
  'somnia-testnet': {
    ...
    explorer: {
      type: 'socialscan',
      webUrl: 'https://somnia-testnet.socialscan.io',
