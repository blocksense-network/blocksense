...
import additionalNetworks from './additional-networks.json';
import { keysOf, valuesOf } from '../array-iter';
...
const chainIds = [
  ...
  324,
  300,
  valuesOf(additionalNetworks)[0].chainId,
] as const;
