...
const chainIds = [
  ...
  200810, 81457, 168587773, 56288, 9728, 288, 28882, 56, 97, 42220, 11142220,
  5115, 1114, 338, 111557560, 127823, 18880, 839999, 250, 4002, 114, 20994, 252,
  2522, 91342, 100, 10200, 13505, 1666700000, 743111, 999, 998, 2424, 57073,
  763373, 747474, 2221, 2368, 1284, 1287, 1285, 59144, 59141, 4202, 994873017,
  2030232745, 169, 3441006, 5000, 5003, 698, 6342, 1740, 59902, 31611, 143,
  10143, 2818, 2810, 72080, 8801, 5851, 5611, 10, 11155420, 688689, 9745, 9746,
  98866, 98867, 137, 80002, 1101, 2442, 695569, 11155931, 57000, 200018, 31,
  534352, 534351, 1328, 11011, 5031, 50312, 1868, 1946, 16, 146, 57054, 14601,
...
export const networkMetadata = {
  ...
  'celo-sepolia': {
    ...
    explorers: [
      {
        type: 'blockscout',
        webUrl: 'https://celo-sepolia.blockscout.com',
  ...
  'etherlink-shadownet': {
    ...
    explorers: [
      {
        type: 'blockscout',
        webUrl: 'https://shadownet.explorer.etherlink.com',
        apiUrl: 'https://shadownet.explorer.etherlink.com//api',
      },
    ],
    currency: Currency.XTZ,
  },
  'expchain-testnet': {
    chainId: 18880,
    isTestnet: true,
    ...
    explorers: [
      {
        ...
        apiUrl: 'https://api.socialscan.io/pharos-atlantic-testnet/v1/explorer',
      },
    ],
