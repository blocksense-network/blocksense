...
export abstract class BaseDataFeedConsumer {
   ...
   */
  public static createConsumerByNetworkName<T extends BaseDataFeedConsumer>(
   ...
   */
  public static createConsumerByRpcUrl<T extends BaseDataFeedConsumer>(
    this: new (contractAddress: Address, client: PublicClient) => T,
    contractAddress: Address,
    rpcUrl: string,
  ): T {
