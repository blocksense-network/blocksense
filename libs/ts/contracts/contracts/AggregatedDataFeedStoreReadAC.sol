...
contract AggregatedDataFeedStoreReadAC {
  ...
  address internal immutable READ_ACCESS_CONTROL;
  ...
  */
  ...
  constructor(address accessControl, address readAccessControl) {
    ACCESS_CONTROL = accessControl;
    READ_ACCESS_CONTROL = readAccessControl;
  }
  ...
  fallback() external payable {
    ...
    address readAccessControl = READ_ACCESS_CONTROL;
    ...
    assembly {
      ...
      if and(
        ...
        // call AC and store return value (32 bytes) at memory location 0x00
        let success := staticcall(gas(), readAccessControl, 0x00, 20, 0x00, 32)
