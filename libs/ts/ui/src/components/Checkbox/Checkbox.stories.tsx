...
export const CheckboxGroupWithNoLabel = () => {
  return (
    <CheckboxGroup>
      <Checkbox id="option4" value="option4" name="exampleOptions">
        Option 4
      </Checkbox>
      <Checkbox id="option5" value="option5" name="exampleOptions">
        Option 5
      </Checkbox>
    </CheckboxGroup>
  );
...
export const CheckboxGroupWithLabel = () => {
  return (
    <CheckboxGroup label="Select your options:">
      <Checkbox id={'option6'} value={'option6'} name={'exampleOptions'}>
        Option 6
      </Checkbox>
      <Checkbox id={'option7'} value={'option7'} name={'exampleOptions'}>
        Option 7
      </Checkbox>
    </CheckboxGroup>
  );
...
const checkBoxes = ['option8', 'option9', 'option10'];

export const ControlledCheckboxGroup = () => {
  const [selectedValues, setSelectedValues] = useState<string[]>(['option6']);
