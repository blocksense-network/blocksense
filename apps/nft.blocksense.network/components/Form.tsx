...
export const Form = () => {
  ...
  return (
    <section className="form md:p-20 px-5 py-8" id="mint-form">
      <article className="form__article max-w-[32.688rem] mx-auto flex flex-col items-center justify-center md:gap-12 gap-8">
        <h2 className="form__title md:text-center">
