...
fn recvd_feed_update_to_block(
    ...
    match recvd_feed_update {
        Some(voted_uptate) => {
            let (key, val) = voted_uptate.update.encode();
...
mod tests {
    ...
    async fn test_block_creator_loop() {
        ...
        let vote_1 = VotedFeedUpdateWithProof {
            update: VotedFeedUpdate::new_decode(k1, v1, end_of_timeslot, FeedType::Numerical(0.0))
                .unwrap(),
            proof: Vec::new(),
        };
        let k2 = "ac000002";
        ...
        let vote_2 = VotedFeedUpdateWithProof {
            update: VotedFeedUpdate::new_decode(k2, v2, end_of_timeslot, FeedType::Numerical(0.0))
                .unwrap(),
            proof: Vec::new(),
        };
        let k3 = "ad000003";
        ...
        let vote_3 = VotedFeedUpdateWithProof {
            update: VotedFeedUpdate::new_decode(k3, v3, end_of_timeslot, FeedType::Numerical(0.0))
                .unwrap(),
            proof: Vec::new(),
        };
        let k4 = "af000004";
        ...
        let vote_4 = VotedFeedUpdateWithProof {
            update: VotedFeedUpdate::new_decode(k4, v4, end_of_timeslot, FeedType::Numerical(0.0))
                .unwrap(),
            proof: Vec::new(),
        };
