...
import { Card, CardDescription, CardHeader } from '@blocksense/ui/Card';
...
export const NetworkAccessCard = ({
  ...
  const { base, quote } = deploymentInfo.contracts.CLAggregatorAdapter[0];
  ...
  return (
    <Card className="data-feed-card-section px-2 py-2">
      <CardHeader className="data-feed-card__header flex flex-col space-y-1.5 px-4 mt-3 mb-3">
        <div className=" data-feed-card__title text-xl font-semibold">
          ...
          label={
            <div className="gap-2 justify-between lg:flex lg:flex-row">
              ...
              <div className="break-all">
                <ContractAddress
                  address={
                    deploymentInfo.contracts.CLAggregatorAdapter[0].address
                  }
                  abbreviation={{ hasAbbreviation: true, bytesToShow: 4 }}
                  copyButton={{ enableCopy: true, background: false }}
                />
            ...
            label={
              <div className="gap-2 justify-between lg:flex lg:flex-row">
                ...
                <div className="break-all">
                  <ContractAddress
                    address={
                      deploymentInfo.contracts.coreContracts
                        .CLFeedRegistryAdapter.address
                    }
                    abbreviation={{ hasAbbreviation: true, bytesToShow: 4 }}
                    copyButton={{ enableCopy: true, background: false }}
                  />
