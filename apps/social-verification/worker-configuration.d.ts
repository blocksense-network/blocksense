/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: eaeecc70496353f804b749972dcda512)
// Runtime types generated with workerd@1.20250508.0 2025-04-23
declare namespace Cloudflare {
  interface Env {
    API_KEY: string;
    DISCORD_BLOCKSENSE_GUILD_ID: string;
    DISCORD_BOT_TOKEN: string;
    NFT_CLIENT_ID: string;
    NFT_PRIVATE_KEY: string;
    NFT_SMART_CONTRACT_ADDRESS: string;
    SOCIAL_DATA_API_KEY: string;
    X_BLOCKSENSE_ACCOUNT_ID: string;
    X_BLOCKSENSE_TWEET_ID: string;
    SENDGRID_API_KEY: string;
    DB: D1Database;
    newsletterDB: D1Database;
  }
}
