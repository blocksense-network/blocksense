...
[^2]: [Life of a Transaction](https://docs.sui.io/concepts/sui-architecture/transaction-lifecycle) - Sui Documentation, accessed July 31, 2025

[^3]: [Back Pressure in Distributed Systems](https://www.geeksforgeeks.org/computer-networks/back-pressure-in-distributed-systems/) - GeeksforGeeks, accessed July 31, 2025

[^4]: [Rahasak blockchain Validate-Execute-Group architecture workflow](https://www.researchgate.net/figure/Rahasak-blockchain-Validate-Execute-Group-architecture-workflow_fig1_349400291) - ResearchGate, accessed July 31, 2025
